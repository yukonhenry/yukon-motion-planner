...
fn dump() {
    let cases: Vec<(&str, usize, usize, Vec<[i32; 2]>)> = vec![
        ...
        ("triangle_closed", 12, 10, vec![[2, 1], [9, 4], [3, 8], [2, 1]]),
        ...
        ("concave_v", 14, 12, vec![[1, 1], [6, 8], [11, 1], [11, 10], [1, 10]]),
        ("horizontal_edge", 10, 8, vec![[1, 2], [8, 2], [8, 5], [1, 5]]),
        ("collinear", 12, 8, vec![[1, 1], [5, 1], [9, 1], [9, 5], [1, 5]]),
