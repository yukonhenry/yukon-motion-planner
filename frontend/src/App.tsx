...
export default function App() {
   ...
   */
  const marks =
    live.run && anchorPlan ? { src: anchorPlan.src_vertex, dest: anchorPlan.dest_vertex } : shown;
        ...
        {draft && (
          <section className="panel">
            ...
            <p className="muted hint">
              The cells the planner blocks. Vertices sit at cell centers, so this is wider than the
              outline — and it is what a route is really avoiding.
            </p>
          </section>
        )}
